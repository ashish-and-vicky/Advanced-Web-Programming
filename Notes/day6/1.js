...
function commentHere() {
  let userComment = document.querySelector("#inputId1").value; // we are not using innerHTML. Why? Bcz this is a form element.
  ...
  //We used commentBox.appendChild(newElement); in previous example.
